      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
              ...
              <div class="d-sm-none d-lg-inline-block">Hi, <?php echo $userName ?></div>
            </a>
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index.php">ShreeShanti</a>
          </div>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a class="nav-link" href="viewvoucher.php"><i class="fas fa-tags"></i><span>Generate Vouchers</span></a></li>
